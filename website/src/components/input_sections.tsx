    ...
    useEffect(() => {
        ...
        if (inputElement) {
            ...
            if (required) {
                ...
                if (isInputFocused) inputElement.style.setProperty("--top-spacing", "8px");
                else inputElement.style.setProperty("--top-spacing", "18px");
            }
        }
                ...
                <div className={styles.selectBorder}>
                    <input
                        ...
                        onChange={(e) => {
                            ...
                            // User has selected an option, so remove the required text
                            setThisRequired(false)
                ...
                <div className={styles.selectBorder}>
                    <div className={styles.advancedTA}>
                        ...
                        <div className={styles.topBar}>
                            <button className={styles.topBarButton} id={"Bold"}> <FontAwesomeIcon icon={faBold} /> </button>
                            <button className={styles.topBarButton} id={"Italic"}> <FontAwesomeIcon icon={faItalic} /> </button>
                            <button className={styles.topBarButton} id={"Underline"}> <FontAwesomeIcon icon={faUnderline} /> </button>
                            <button className={styles.topBarButton} id={"StrikeThrough"}> <FontAwesomeIcon icon={faStrikethrough} /> </button>
                            <button className={styles.topBarButton} id={"Link"}> <FontAwesomeIcon icon={faLink} /> </button>
                            <button className={styles.alignLeft} id={"AlignLeft"}><FontAwesomeIcon icon={faAlignLeft} /> </button>
                            <button className={styles.alignCenter} id={"AlignCenter"}> <FontAwesomeIcon icon={faAlignCenter} /> </button>
                            <button className={styles.alignRight} id={"AlignRight"}> <FontAwesomeIcon icon={faAlignRight} /> </button>
                        </div>

                        {/* Text area for user to input into*/}
                        <SimpleTextArea placeHolder={placeHolder} required={required} state={state} errorText={errorText} changeEventHandler={changeEventHandler} />
                    </div>
                </div>
            </div>
        </>
